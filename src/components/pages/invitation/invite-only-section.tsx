...
import InviteOnlyUsers from '@components/organisms/invite-link/invite-only.organisms';
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="border-b-2 pb-4">
        ...
        {showGenrateLinkForm && (
          <div className="w-3/5">
            <GenerateLink testId={testId} testLinkType={TestLinkType.Invite_Only} />
          </div>
        )}
      </div>
      <div className="border-b-2 pb-4">
        <InviteOnlyUsers allLinkOfPersonal={allLinkOfPersonal} />
      </div>
