...
`,
              ...
              },
              {
                ...
                questionExplanation: 'This question evaluates the candidate’s understanding of dynamic memory allocation functions in the C standard library.',
                answerExplanation: '`malloc(size)` allocates a block of memory of the specified size but does not initialize it. `calloc(n, size)` allocates memory for an array of `n` elements and initializes all bytes to zero.'
              }                        
            ]
          },
          {
  ...
  return(
    <>
        <CandidateProfileDetails
          user={reviewDetailedResultData.user}
          test={reviewDetailedResultData.test}
          testResults={reviewDetailedResultData.testResults[0]}
          showBackButton={true}
          statusElement={
            <VStatus
      ...
      <div className="mt-6">
        {reviewDetailedResultData && (
          <>
            <AssessmentQuestionTable detailedResultData={reviewDetailedResultData} onReviewQuestion={handleReviewQuestion} />
